    ...
    <div className="app-wrapper">
      ...
      <div className="journey-selector-section">
        ...
        <div className="journey-cards-grid three-col">
          ...
          <Link to="/packages" className="journey-card">
            ...
            <div className="journey-card-content">
              ...
              <div className="journey-card-cta">Explore Tours <span className="journey-card-arrow">→</span></div>
